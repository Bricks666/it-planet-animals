...
func (ad *AreaDelete) Exec(ctx context.Context) (int, error) {
	return withHooks[int, AreaMutation](ctx, ad.sqlExec, ad.mutation, ad.hooks)
}
...
func (ad *AreaDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(area.Table, sqlgraph.NewFieldSpec(area.FieldID, field.TypeUint64))
