...
func (e AreaEdges) PointsOrErr() ([]*Location, error) {
	if e.loadedTypes[0] {
		return e.Points, nil
	}
...
// QueryPoints queries the "points" edge of the Area entity.
func (a *Area) QueryPoints() *LocationQuery {
	return NewAreaClient(a.config).QueryPoints(a)
}
